...
export const Telegramas = ({ cliente, estadoCli }) => {
    ...
    return (
        ...
        <div className='mt-3'>
            ...
            <TabsUnstyled defaultValue={0}>
                ...
                <TabPanel value={0}>
                    <Documentos cliente={cliente} estadoCli={estadoCli} telegramaCli={telegramaCliente}/>
                </TabPanel>

                <TabPanel value={1}>
                    <Firmas cliente={cliente} estadoCli={estadoCli}/>
                </TabPanel>
