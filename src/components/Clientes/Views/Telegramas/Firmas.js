...
export const Firmas = ({ cliente, estadoCli }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/clientes/firmas/${cliente.cuit_cuil}`).then((resp) => {
    ...
    const handleFirmaPoder = () => {
        ...
        if (firmaPoder) {
            ...
            axios.put(`http://localhost:3001/clientes/firmas/${firmasCliente.id}`, data).then((response) => {
