...
export const EstadosOpcionales = ({ expediente }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/general/juiciosOpcionales?data=${expediente.numeroExp}`).then((resp) => {
    ...
    const handleEmbargo = () => {
        ...
        axios.put(`http://localhost:3001/juicios/opcional/estado/${estadosJuicio.id}`, dataEstado);

        axios.put(`http://localhost:3001/juicios/opcional/fechas/${fechasJuicio.id}`, dataFechas);
    ...
    const handleSentenciaSeg = () => {
        ...
        axios.post(`http://localhost:3001/expedientes/capitales/segunda`, expediente_capitalSegunda).then((response) => {
    ...
    const handleActualizacion = () => {
        ...
        axios.post(`http://localhost:3001/expedientes/capitales/actualizacion`, expediente_capitalActualizacion).then((response) => {
            console.log('Capital Segunda Creado: ', response.data);
        });
