...
export const SecretariaScreen = ({ cliente, sc, estadoCli }) => {
    ...
    const handleEstablecerDenuncia = () => {
        ...
        axios.put(`http://localhost:3001/clientes/secretaria/${secretariaCliente.id}`, data).then((response) => {
    ...
    const handleActualizarEstado = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.put(`http://localhost:3001/clientes/estados/${estadoCli.id}`, estado_cliente).then((response) => {
                    console.log('Estado Actualizado: ', response.data);
                });
    ...
    const handleCambiarJuicio = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.delete(`http://localhost:3001/clientes/secretaria/${secretariaCliente.id}`).then((response) => {
