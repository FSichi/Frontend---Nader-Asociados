...
export const EstadoExpediente = ({ expediente, history }) => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/juicios/obligatorio/estado/ind?data=${expediente.numeroExp}`).then((resp) => {
            setEstadosJuicio(resp.data);
        });

        axios.get(`http://localhost:3001/general/estadoExp?data=${expediente.numeroExp}`).then((resp) => {
    ...
    const handleActualizar = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.put(`http://localhost:3001/expedientes/${expediente.id}`, data);
                ...
                listofClientes.forEach(cliente => {
                    ...
                    axios.put(`http://localhost:3001/clientes/estados/${cliente.id}`, estadoCliente);
